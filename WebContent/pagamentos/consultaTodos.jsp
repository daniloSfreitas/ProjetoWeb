...
<html><head>
    ...
    <link href="../lib/css/bootstrap.css" rel="stylesheet" type="text/css">
     ...
     <title>Pagina de Consultar Todos os Pagamento</title>
  </head><body>
    ...
    <div class="section">
       <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
             <h3 class="tt_menu">&gt;&gt; CLIENTES - CONSULTAR TODOS OS PAGAMENTOS &lt;&lt;</h3>
         </div>
     </div>     
    <div class="section section-danger text-justify">
      <div class="container">
          ...
          <div class="col-md-12 text-center">
            ...
            <table align="center" border="1">
              <tr>
                  <th>CPF</th>
                  <th>CDCURSO</th>
                  <th>DATA DE INSCRIÇÂO</th>
              </tr>
             <c:forEach var="row" items="${pagamento}"> 
                 <tr>
